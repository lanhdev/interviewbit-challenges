...
class Solution
  ...
  def firstMissingPositive(a)
    ...
    (1..(n + 1)).each do |num|
      return num unless hash.include?(num)
    end
  end
end
...
class Solution
  ...
  def firstMissingPositive(a)
    n = a.size
    idx = 0
    # Segregate positive to right side of array
    while idx < n do
      val = a[idx]
      if val > 0 && val < n + 1
        a[n + val] = val
...
p Solution.new.firstMissingPositive(a)
p Solution.new.firstMissingPositive(b)
p Solution.new.firstMissingPositive(c)
p Solution.new.firstMissingPositive(d)
